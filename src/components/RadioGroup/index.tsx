  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator
        ...
        className={cn("relative flex items-center justify-center", indicadorClassName)}
      >
        <CircleIcon className={cn("absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2", circleClass, circleClassName)} />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
